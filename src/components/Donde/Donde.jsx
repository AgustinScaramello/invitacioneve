...
import marcador from "../../assets/marcador.svg" // Tu ícono SVG personalizado
...
export const Donde = ({ audioRef }) => {
	...
	const position = [-34.807818734043096, -58.2675428320896]
	...
	return (
		<div id="containerDondeGeneral" className="abrirModalDesliza">
			...
			<motion.div id="containerMapa" ref={mapRef} initial="hidden" animate={isMapInView ? "visible" : "hidden"} variants={mapVariants}>
					...
					<Marker position={position} icon={customIcon}>
						<Popup permanent closeButton={false}>
							<div className="popupMapa">
								...
								<p className="palabrasPopup">Mitre 674 - Fcio. Varela</p>
							</div>
						</Popup>
					</Marker>
				</MapContainer>
				...
				<motion.div className="btnGoogleMaps" variants={buttonVariants} whileHover="hover" whileTap={{ scale: 0.95 }}>
					<a href="https://maps.app.goo.gl/mN4N6NykvRJefSs3A" className="urlBtnGoogleMaps" onClick={apagarMusica}>
						CLICK AQUI PARA IR GOOGLE MAPS{" "}
