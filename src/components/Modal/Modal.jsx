                ...
                <div class="containerModalRegalo modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>
                            ...
                            <img src={iconCopy} alt="" id="copyCvu" className="iconCopy heartbeat" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="CVU COPIADO" onClick={() => handleCopy(1)} />
                        </p>
                        <p>
                            Alias: <b>Evelin.brs</b>
                            <img src={iconCopy} alt="" id="copyAlias" className="iconCopy heartbeat" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="ALIAS COPIADO" onClick={() => handleCopy(2)} />
                        </p>
                        <p>
                            <b>Mercado Pago</b>
                        </p>
